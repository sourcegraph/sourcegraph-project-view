# Project view ([Sourcegraph extension](https://docs.sourcegraph.com/extensions))
...
A [Sourcegraph extension](https://docs.sourcegraph.com/extensions) for viewing and visualizing projects defined in Markdown files in a repository.
